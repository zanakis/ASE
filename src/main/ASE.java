...
public class ASE {
	...
	public static void makeFiles() throws FileNotFoundException {
	...
	public static void readFiles() {
		storeEntries = new HashMap<Integer, String>();
		...
		for(int i = 0; i < entries.size(); i++) {
			...
			storeEntries.put(Integer.parseInt(s0[0]), s0[1]);
		}
	}

	public static void connectToSimulator() throws Exception {
		String host;
		int port = 0;
	...
	static HashMap<Integer, String> storeEntries;
